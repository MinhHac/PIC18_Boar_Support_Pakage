...
void lcd_i2c_init(uInt8_t slave_Add,uInt8_t data_Add);
void lcd_i2c_sendChar(uInt8_t data,uInt8_t slave_Add,uInt8_t data_Add);
void lcd_i2c_sendCommand(uInt8_t data,uInt8_t slave_Add,uInt8_t data_Add);
void lcd_i2c_sendString(char *str,uInt8_t slave_Add,uInt8_t data_Add);
void lcd_i2c_gotoXY(uInt8_t row, uInt8_t col,uInt8_t slave_Add,uInt8_t data_Add);
void lcd_i2c_sendStringXY(uInt8_t *str,uInt8_t row, uInt8_t col,uInt8_t slave_Add,uInt8_t data_Add);
