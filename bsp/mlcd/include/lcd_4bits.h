#ifndef _LCD_4BITS_H_
#define _LCD_4BITS_H_
/*-----------------------------------------------------------------------------
* Includes
*------------------------------------------------------------------------------
*/
...
#define	LCD_DATA_OUT       TRISD           // mode 4 bits poids forts 4567

/* pin I/O */
#define	LCD_EN               LATEbits.LATE1
#define LCD_RS               LATEbits.LATE0
#define LCD_DATA             LATD        // mode 4 bits use LATD=LATD|0xF0
