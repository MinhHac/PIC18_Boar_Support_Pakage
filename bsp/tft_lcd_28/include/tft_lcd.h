...
#define TFT_RES_DIR  TRISCbits.TRISC1
#define TFT_DC_DIR   TRISCbits.TRISC0

#define TFT_RES      LATCbits.LATC1  
#define TFT_DC       LATCbits.LATC0
//==============================================================================


/* CONSTANCE */
#define TFT_D        1 // Data
#define TFT_C        0 // Command
...
/*variable global*/
//extern uInt16_t global_bg_color; // background
...
uInt8_t initcmd[] = {
  ...
  ILI9341_SLPOUT  , 0x80,                // Exit Sleep+delay 200
  ILI9341_DISPON  , 0x80,                // Display on+delay 200
  
  0x36,1,0x40,                           // memoire acsse control
  0x00                                   //end
};

// Standard ASCII 5x7 font
#ifndef _FONT5X7_H
const uInt8_t mfont[256][5] = {
